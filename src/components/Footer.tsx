    ...
    <footer className="bg-[#0A0A0A] text-white pt-10 md:pt-16 pb-6 md:pb-8 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 pb-8 md:pb-12 border-b border-white/10">
          {/* Logo + tagline */}
          <div>
            <h2 className="text-lg sm:text-xl lg:text-2xl font-black tracking-[0.2em] mb-2 sm:mb-3">
              NORTHSTONE
            </h2>
            <div className="w-10 h-px bg-[#B8985A] mb-4 sm:mb-5" />
          ...
          <div className="lg:max-w-md lg:ml-auto w-full">
            <p className="text-[10px] sm:text-[10px] tracking-[0.3em] uppercase text-white/60 mb-2 sm:mb-3">
              Newsletter
            </p>
            ...
            <form className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <input
                ...
                className="flex-1 bg-transparent border border-white/30 px-4 py-2.5 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-white transition-colors"
              />
              <button
                type="submit"
                className="px-5 py-2.5 bg-[#B8985A] text-[#0A0A0A] text-[10px] tracking-[0.2em] uppercase font-semibold hover:bg-[#D4B574] transition-colors whitespace-nowrap"
              >
                S'inscrire
              </button>
            </form>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-6 md:gap-10 py-8 md:py-12">
          {columns.map((column) => (
            <div key={column.title}>
              <h4 className="text-[10px] sm:text-[10px] tracking-[0.3em] uppercase text-white/60 mb-2 sm:mb-4">
                {column.title}
              </h4>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 pt-6 md:pt-8 border-t border-white/10">
