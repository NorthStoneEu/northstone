    ...
    <div className="bg-black text-white">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 py-24">
        <div className="max-w-3xl mx-auto flex flex-col items-center gap-8">
          <h1 className="text-7xl sm:text-8xl md:text-[10rem] font-bold tracking-widest uppercase leading-none">
            Northstone
          </h1>

          <p className="text-sm md:text-base tracking-[0.45em] text-zinc-400 uppercase">
      ...
      {/* ── DROP 01 ───────────────────────────────────────────── */}
      <section id="drop-01" className="py-24 md:py-36 px-6 border-t border-zinc-900">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-12">
          ...
          <p className="animate-on-scroll text-zinc-400 text-base md:text-lg leading-relaxed max-w-2xl">
          ...
          <div className="animate-on-scroll w-full grid grid-cols-1 sm:grid-cols-3 border border-zinc-800">
            <div className="flex flex-col items-center gap-2 py-10 px-6 sm:border-r border-zinc-800">
              <span className="text-5xl font-bold">400</span>
              <span className="text-xs tracking-[0.3em] text-zinc-500 uppercase">
                Pièces numérotées
              </span>
            </div>
            <div className="flex flex-col items-center gap-2 py-10 px-6 border-t sm:border-t-0 sm:border-r border-zinc-800">
              <span className="text-5xl font-bold">130</span>
              <span className="text-xs tracking-[0.3em] text-zinc-500 uppercase">
                Gagnants
              </span>
            </div>
            <div className="flex flex-col items-center gap-2 py-10 px-6 border-t sm:border-t-0 border-zinc-800">
      ...
      {/* ── LE CONCEPT ────────────────────────────────────────── */}
      <section className="py-24 md:py-36 px-6 border-t border-zinc-900">
        <div className="max-w-5xl mx-auto flex flex-col gap-16">

          <div className="animate-on-scroll text-center flex flex-col gap-4">
            <p className="text-xs tracking-[0.45em] text-zinc-500 uppercase">
              Le concept
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border border-zinc-900">
            ...
            {/* Authentification */}
            <div className="animate-on-scroll flex flex-col gap-6 p-10 md:border-r border-zinc-900 border-b md:border-b-0">
            ...
            <div className="animate-on-scroll flex flex-col gap-6 p-10">
              <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      {/* ── MANIFESTE ─────────────────────────────────────────── */}
      <section className="py-24 md:py-40 px-6 border-t border-zinc-900">
        <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-8 animate-on-scroll">
          <p className="text-xs tracking-[0.45em] text-zinc-600 uppercase">
            Manifeste
          </p>
          <blockquote className="text-2xl md:text-3xl font-light leading-relaxed text-zinc-200 italic">
