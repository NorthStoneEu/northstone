...
export default function AdminDashboard({
  ...
  const sections = [
    ...
    { titre: "Commandes boutique", desc: "Collection permanente", href: "/admin/commandes", actif: true, icone: "M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18M16 10a4 4 0 0 1-8 0" },
    { titre: "Commandes drop", desc: "Pièces en édition limitée", href: "/admin/commandes-drop", actif: true, icone: "M12 2l2.4 7.4H22l-6 4.6 2.3 7.4-6.3-4.6-6.3 4.6L8 14 2 9.4h7.6z" },
